//! Four-avenue web ↔ API binding for `happy-wakey`.
//!
//! 1. Direct read-only DB via `*-lib-core` named queries (no migrations).
//! 2. Stateless HTTP from `app.happy-wakey.dev` to `api.happy-wakey.dev`.
//! 3. Stateful TLS 1.3/mTLS TCP to `api.happy-wakey.dev:7443`.
...
pub const GITHUB_ORG: &str = "happy-wakey";
pub const ORG_SLUG: &str = "happy-wakey";
pub const DNS_ZONE: &str = "happy-wakey.dev";
